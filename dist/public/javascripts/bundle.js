...
/******/return __webpack_require__(__webpack_require__.s=2);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(process){if(process.env.NODE_ENV==='production'){module.exports=__webpack_require__(3);}else{module.exports=__webpack_require__(4);}/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(1));/***/},/* 1 *//***/function(module,exports,__webpack_require__){"use strict";// shim for using process in browser
...
process.versions={};function noop(){}process.on=noop;process.addListener=noop;process.once=noop;process.off=noop;process.removeListener=noop;process.removeAllListeners=noop;process.emit=noop;process.prependListener=noop;process.prependOnceListener=noop;process.listeners=function(name){return[];};process.binding=function(name){throw new Error('process.binding is not supported');};process.cwd=function(){return'/';};process.chdir=function(dir){throw new Error('process.chdir is not supported');};process.umask=function(){return 0;};/***/},/* 2 *//***/function(module,exports,__webpack_require__){"use strict";var _react=__webpack_require__(0);var _react2=_interopRequireDefault(_react);var _reactDom=__webpack_require__(5);var _reactDom2=_interopRequireDefault(_reactDom);var _ShoppingList=__webpack_require__(8);var _ShoppingList2=_interopRequireDefault(_ShoppingList);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_reactDom2.default.render(_react2.default.createElement(_ShoppingList2.default,null),document.getElementById('root'));/***/},/* 3 *//***/function(module,exports,__webpack_require__){"use strict";/** @license React v16.2.0
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var _assign=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"object-assign\"");e.code='MODULE_NOT_FOUND';throw e;}());var emptyObject=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/emptyObject\"");e.code='MODULE_NOT_FOUND';throw e;}());var invariant=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/invariant\"");e.code='MODULE_NOT_FOUND';throw e;}());var warning=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/warning\"");e.code='MODULE_NOT_FOUND';throw e;}());var emptyFunction=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/emptyFunction\"");e.code='MODULE_NOT_FOUND';throw e;}());var checkPropTypes=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"prop-types/checkPropTypes\"");e.code='MODULE_NOT_FOUND';throw e;}());// TODO: this is special because it gets imported during build.
...
checkDCE();module.exports=__webpack_require__(6);}else{module.exports=__webpack_require__(7);}/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(1));/***/},/* 6 *//***/function(module,exports,__webpack_require__){"use strict";/** @license React v16.2.0
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(0);var invariant=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/invariant\"");e.code='MODULE_NOT_FOUND';throw e;}());var warning=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/warning\"");e.code='MODULE_NOT_FOUND';throw e;}());var ExecutionEnvironment=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/ExecutionEnvironment\"");e.code='MODULE_NOT_FOUND';throw e;}());var _assign=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"object-assign\"");e.code='MODULE_NOT_FOUND';throw e;}());var emptyFunction=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/emptyFunction\"");e.code='MODULE_NOT_FOUND';throw e;}());var EventListener=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/EventListener\"");e.code='MODULE_NOT_FOUND';throw e;}());var getActiveElement=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/getActiveElement\"");e.code='MODULE_NOT_FOUND';throw e;}());var shallowEqual=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/shallowEqual\"");e.code='MODULE_NOT_FOUND';throw e;}());var containsNode=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/containsNode\"");e.code='MODULE_NOT_FOUND';throw e;}());var focusNode=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/focusNode\"");e.code='MODULE_NOT_FOUND';throw e;}());var emptyObject=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/emptyObject\"");e.code='MODULE_NOT_FOUND';throw e;}());var checkPropTypes=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"prop-types/checkPropTypes\"");e.code='MODULE_NOT_FOUND';throw e;}());var hyphenateStyleName=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/hyphenateStyleName\"");e.code='MODULE_NOT_FOUND';throw e;}());var camelizeStyleName=__webpack_require__(!function webpackMissingModule(){var e=new Error("Cannot find module \"fbjs/lib/camelizeStyleName\"");e.code='MODULE_NOT_FOUND';throw e;}());/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
